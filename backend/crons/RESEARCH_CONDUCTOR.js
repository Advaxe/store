// Temporarily disabled for store application
 ...
 */
const TIME_TO_ACCEPT = 30  // Default value since TIMING is disabled

/**
 * Le temps additionnel pour accepter la demande
 * @author Dukizwe Darcy <darcy@mediabox.bi>
 */
const ADDITIONAL_SECONDS = 10  // Default value since TIMING is disabled

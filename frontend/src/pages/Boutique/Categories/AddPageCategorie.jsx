  ...
  return (
    <>
      ...
      <div className="px-4 py-3 main_content bg-white has_footer">
        <div className="">
          <h1 className="mb-3">New Category</h1>
          <hr className="w-100" />
        </div>
          ...
          <div className="form-group col-sm">
            <div className="row">
              ...
              <div className="col-sm">
                <InputText autoFocus type="text" placeholder="The category" id="DESIGNATION" name="DESIGNATION" value={data.DESIGNATION} onChange={handleChange} onBlur={checkFieldData} className={`w-100 is-invalid ${hasError('DESIGNATION') ? 'p-invalid' : ''} `} />

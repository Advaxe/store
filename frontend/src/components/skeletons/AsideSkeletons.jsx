                        ...
                        <h1>Hello Advaxe</h1>
                              <div className="rounded bg-white p-3">
                                        <div className="d-flex align-items-center justify-content-between mb-4">
                                                  <Skeleton width="15rem" height="1.5rem" shape='rectangle' className="mb-2">888</Skeleton>
                                        </div>
                              ...
                              <h1>Hello Advaxe</h1>
                                        ...
                                        <div className="d-flex">
                                                  <div className="div" style={{ marginRight: 20 }}>
                                                            <Skeleton width="5rem" height='0.8rem'  className="mb-2">1</Skeleton>
                                                            <Skeleton width="10rem" height='0.6rem'  className="mb-2">2</Skeleton>
                                                            <Skeleton width="3rem" height='0.6rem'  className="">3</Skeleton>
                                                  </div>
                                                  <Skeleton width="5rem" height="4rem" borderRadius="16px" ></Skeleton>
                                        </div>
                                        <div className="d-flex mt-3">

          ...
          return (
                    <div className="div rounded bg-white p-3">
                              ...
                              <div className="d-flex align-items-end justify-content-between mb-2" style={{ height: 300 }}>
                                        ...
                                        <div className="d-flex align-items-end flex-fill h-100">
                                                  <div className="vr"></div>
                                                  <div className="flex-fill mx-2 h-50" style={{ backgroundColor: '#abb3aa', borderRadius: 3}}></div>
                                        </div>
                                        <div className="d-flex align-items-end flex-fill h-100">
                                                  <div className="vr"></div>
                                                  <div className="flex-fill mx-2 h-75" style={{ backgroundColor: '#bfb3a1', borderRadius: 3}}></div>
                                        </div>
                                        <div className="d-flex align-items-end flex-fill h-100">
                                                  <div className="vr"></div>
